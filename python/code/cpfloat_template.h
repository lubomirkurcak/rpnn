...
#define FPUNION2 ADDSUFFIXTO(fpint2)
typedef union {
  FPTYPE fpval;
  INTTYPE intval;
} FPUNION2;
...
#define INTOF(x)(((FPUNION2 *)(x))->intval)
#define INTOFCONST(x)(((FPUNION2 *)(x))->intval)
#define FPOF(x)(((FPUNION2 *)(x))->fpval)
*/

#define INTCONST(x) CONCATENATE(x, INTSUFFIX)

#define INTOF(x)(((FPUNION *)(x))->intval)
//#define INTOFCONST(x)(((FPUNION *)(x))->intval)
//#define INTOFCONST(x)(((FPTYPE*)(x))->intval)


//#define INTOFCONST(x)(((FPUNION){.fpval = (FPTYPE)x}).intval)
INTTYPE INTOFCONST(FPTYPE x)
{
    FPUNION u;
    u.fpval = (FPTYPE)x;
    return u.intval;
...
//#define INTOFCONST(x)(((FPUNION){.fpval = (FPTYPE)x}).intval)
//#define FPOF(x)(((FPUNION){.intval = (INTTYPE)(x)}).fpval)
//#define INTOFCONST(x) (*((INTTYPE *)&((FPTYPE)(x+0))))
//#define FPOF(x) (*((FPTYPE *)&((INTTYPE)(x))))
...
static inline int VALIDATE_INPUT(optstruct *fpopts) {
...
static inline FPPARAMS COMPUTE_GLOBAL_PARAMS(optstruct *fpopts,
                                             int *retval) {
...
static inline void UPDATE_LOCAL_PARAMS(FPTYPE *A,
                                       FPPARAMS *params,
                                       LOCPARAMS *lparams) {
...
GENERATE_INTERFACE(modf,
                   (FPTYPE *X, FPTYPE *intpart), FPTYPE *A,
                   X+i, A+i,
                   (X, intpart), A,
                   NOOP, INTRODUCE_BITFLIP,
...
GENERATE_INTERFACE(scalbln,
                   FPTYPE *X, (FPTYPE *A, long int *exp),
                   X+i, A+i,
                   X, (A, exp),
                   NOOP, INTRODUCE_BITFLIP,
...
GENERATE_INTERFACE(rint,
                   (FPTYPE *X, int *exception),  FPTYPE *A,
                   X+i, A+i,
                   (X, exception), A,
